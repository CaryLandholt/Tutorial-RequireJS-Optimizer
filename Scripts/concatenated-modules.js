 ...
 *
 * Date: Fri Jan 20 16:47:49 2012 -0500
 */
 ...
 * window
 * Version:  1.0.0
 * Source:  https://github.com/CaryLandholt/window
 *
 ...
 *
 * Description
 * A module providing access to the window object
 *
 * Dependencies
...
define('doc',['jquery', 'document'], function ($, document) {
...
define('pubsub',['jquery', 'doc'], function ($, $doc) {
...
define('subscribe',['pubsub'], function (pubsub) {
...
define('unsubscribe',['pubsub'], function (pubsub) {
...
define('textchange',['jquery', 'window', 'subscribe', 'unsubscribe'], function ($, window, subscribe, unsubscribe) {
...
define('dirty',['jquery', 'subscribe', 'unsubscribe', 'textchange'], function ($, subscribe, unsubscribe) {
...
define('app',['jquery', 'window', 'subscribe', 'dirty'], function ($, window, subscribe) {
